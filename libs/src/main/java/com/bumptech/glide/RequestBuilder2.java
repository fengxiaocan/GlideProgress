...
public class RequestBuilder2<TranscodeType> extends RequestBuilder<TranscodeType> {
    ...
    protected RequestBuilder2(Class<TranscodeType> transcodeClass, RequestBuilder2 other) {
        super(transcodeClass, other);
        this.glideUrl = other.glideUrl;
        this.requestManager2 = other.requestManager2;
        this.glideProgressPack = other.glideProgressPack;
    }
